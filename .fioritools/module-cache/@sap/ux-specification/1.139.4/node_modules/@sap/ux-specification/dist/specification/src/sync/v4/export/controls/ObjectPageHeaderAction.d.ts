...
export declare class ObjectPageHeaderAction implements v4.ObjectPageHeaderAction {
...
export declare class ObjectPageHeaderActionGroup implements v4.ObjectPageHeaderActionGroup {
    [key: string]: ObjectPageHeaderAction;
}
/**
...
export declare class CustomHeaderActionOP implements v4.CustomHeaderActionOP {
    text: string;
