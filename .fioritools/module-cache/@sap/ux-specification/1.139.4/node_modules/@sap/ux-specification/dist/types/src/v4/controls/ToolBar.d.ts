...
export interface ToolBarActionGroup {
    [id: string]: ToolBarAction;
}
export interface ViewToolBarActionGroup {
    [id: string]: ViewToolBarAction;
}
/**
 * Action
 *
...
export interface Actions {
    [key: string]: ToolBarAction | CustomTableAction | ToolBarActionGroup;
}
/**
 * Actions
 *
...
export interface ViewActions {
    [key: string]: ViewToolBarAction | ChartToolBarAction | ViewTableCustomAction | ViewToolBarActionGroup;
}
/**
 * Table Toolbar
 *
