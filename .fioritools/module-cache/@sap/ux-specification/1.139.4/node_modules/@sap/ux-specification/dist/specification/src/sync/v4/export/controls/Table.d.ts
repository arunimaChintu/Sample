 ...
 * @returns {void} No return value; the method updates the manifestSection object directly by reference.
 */
 ...
 */
export declare function importEnableMassEdit(manifestSection: any): false | {
    visibleFields?: string[];
    ignoredFields?: string[];
    operationGroupingMode?: v4.OperationGroupingMode;
};
/**
