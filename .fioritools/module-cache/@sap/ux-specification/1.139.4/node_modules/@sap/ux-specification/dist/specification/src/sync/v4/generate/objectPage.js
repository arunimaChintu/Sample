...
function adjustRowCountMode(v4Page, facetKey, appSchema, tableDefinition) {
    ...
    if (rowCountMode && rowCountMode !== ux_specification_types_1.v4.RowCountMode.Auto) {
        (0, common_1.addMessageToSchema)(rowCountModeDefinition, i18next_1.default.t('WARNING_DEFAULT_ROW_COUNT_MODE'));
    }
}
/**
 ...
 * @returns {void} This function does not return a value.
 */
function handleLineItem(facet, facetKey, appSchema, lineItemFacet, oDataServiceAVT, v4Page, logger, isCollection) {
...
function handleSectionTable(facet, facetKey, appSchema, lineItemFacet, generateParameters, v4Page, sections, isCollection) {
    ...
    handleLineItem(facet, facetKey, appSchema, lineItemFacet, generateParameters.serviceAVT, v4Page, generateParameters.logger, isCollection);
    return sectionTable;
}
/**
