import type { CustomActionPositionOP } from './CustomAction';
...
export interface ObjectPageToolBarActionGroup {
    [id: string]: ObjectPageToolBarAction;
}
/**
 * Actions
 *
...
export interface ObjectPageToolBarActions {
    [key: string]: ObjectPageToolBarAction | CustomTableActionOP | ObjectPageToolBarActionGroup;
}
/**
 * Toolbar
 *
